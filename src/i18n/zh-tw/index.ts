export default {
  ...
  Game: {
    ...
    BTCHash: {
      ...
      Item: {
        '1': { title: '個位-單雙',sctitle: ['個位'], subtitle: [ '單', '雙' ] },
        '2': { title: '十位-單雙',sctitle: ['十位'], subtitle: [ '單', '雙' ] },
        '3': { title: '百位-單雙',sctitle: ['百位'], subtitle: [ '單', '雙' ] },
        '4': { title: '千位-單雙',sctitle: ['千位'], subtitle: [ '單', '雙' ] },
        '5': { title: '萬位-單雙',sctitle: ['萬位'], subtitle: [ '單', '雙' ] },
        '6': { title: '個位-大小',sctitle: ['個位'], subtitle: [ '大', '小' ] },
        '7': { title: '十位-大小',sctitle: ['十位'], subtitle: [ '大', '小' ] },
        '8': { title: '百位-大小',sctitle: ['百位'], subtitle: [ '大', '小' ] },
        '9': { title: '千位-大小',sctitle: ['千位'], subtitle: [ '大', '小' ] },
        '10': { title: '萬位-大小',sctitle: ['萬位'], subtitle: [ '大', '小' ] },
        '11': { title: '個位-質合',sctitle: ['個位'], subtitle: [ '質', '合' ] },
        '12': { title: '十位-質合',sctitle: ['十位'], subtitle: [ '質', '合' ] },
        '13': { title: '百位-質合',sctitle: ['百位'], subtitle: [ '質', '合' ] },
        '14': { title: '千位-質合',sctitle: ['千位'], subtitle: [ '質', '合' ] },
        '15': { title: '萬位-質合',sctitle: ['萬位'], subtitle: [ '質', '合' ] },
        '16': {title: '總和-單雙',sctitle: ['總和'],  subtitle: [ '單', '雙' ]},
        '17': {title: '總和-大小',sctitle: ['總和'],  subtitle: [ '大', '小' ]},
        '18': {title: '前3和-單雙',sctitle: ['前3和'],  subtitle: [ '單', '雙' ]},
        '19': {title: '前3和-大小',sctitle: ['前3和'],  subtitle: [ '大', '小' ]},
        '20': {title: '中3和-單雙',sctitle: ['中3和'],  subtitle: [ '單', '雙' ]},
        '21': {title: '中3和-大小',sctitle: ['中3和'],  subtitle: [ '大', '小' ]},
        '22': {title: '後3和-單雙',sctitle: ['後3和'],  subtitle: [ '單', '雙' ]},
        '23': {title: '後3和-大小',sctitle: ['後3和'],  subtitle: [ '大', '小' ]},
        ...
        '41': {title: '四字現'},
        '42': {title: '五字現'},
        '43': {title: '雜項-前3',sctitle: ['前3'],subtitle:['豹子','順子','對子','半順','雜六']},
        '44': {title: '雜項-中3',sctitle: ['中3'],subtitle:['豹子','順子','對子','半順','雜六']},
        '45': {title: '雜項-後3',sctitle: ['後3'],subtitle:['豹子','順子','對子','半順','雜六']},
    ...
    HashSix: {
      ...
      Item: {
        ...
        '80': { title: 'KENO5'},
        '81': { title: 'KENO6'},
        '5': { title: '總和單雙', shortT: '合', subtitle: [ '單', '雙' ]},
        '6': { title: '總和大小', shortT: '合', subtitle: [ '單', '雙' ]},              
        '12':{ 
          title: '正碼1-6單雙',
