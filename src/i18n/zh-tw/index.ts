export default {
  ...
  Game: {
    ...
    KENO: {
      Menu: {
        Group: [
          { title: 'KENO 2', SubItem: [] },
          { title: 'KENO 3', SubItem: [] },
          { title: 'KENO 4', SubItem: [] },
          { title: 'KENO 5', SubItem: [] },
          { title: 'KENO 6', SubItem: [] },
          { title: 'KENO 7', SubItem: [] },
          { title: 'KENO 8', SubItem: [] },
          { title: 'KENO 9', SubItem: [] },
          { title: 'KENO 10', SubItem: [] },
        ],
      },
      Item: {
        1: { title: 'KENO 2' },
